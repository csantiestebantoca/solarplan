...
'Angle Distribution': 'Angle Distribution',
...
'Category frequency analysis': 'Category frequency analysis',
...
'Farms control': 'Farms control',
'Farms_control': 'Farms_control',
...
'Frequency Distribution Analysis': 'Frequency Distribution Analysis',
...
'Inverter Daily Specific Production': 'Inverter Daily Specific Production',
'Inverter Efficiency': 'Inverter Efficiency',
'Inverter Loses': 'Inverter Loses',
'Inverter Losses': 'Inverter Losses',
'Inverter Real Times': 'Inverter Real Times',
'Inverter Shutdown Times': 'Inverter Shutdown Times',
'Inverter Startup Times': 'Inverter Startup Times',
'Invitation to join %(site)s': 'Invitation to join %(site)s',
'IV Tracing analysis': 'IV Tracing analysis',
'IV_Tracing_analysis': 'IV_Tracing_analysis',
'Key': 'Llave',
'Key verified': 'Key verified',
'Last name': 'Apellido',
'Layout': 'Diseño de página',
'Limiting Loses': 'Limiting Loses',
...
'Loss Variations By Type (%)': 'Loss Variations By Type (%)',
'Lost Password': 'Contraseña perdida',
'Lost your password?': 'Lost your password?',
'Low Light Loses': 'Low Light Loses',
'Manage %(action)s': 'Gestionar %(action)s',
'Manage Access Control': 'Gestionar control de acceso',
'Manage Cache': 'Gestionar la Caché',
'Maximum Angle Deviation': 'Maximum Angle Deviation',
'Mean Angle Deviation': 'Mean Angle Deviation',
'Mega reporte': 'Mega reporte',
...
'Plant Summary': 'Plant Summary',
'please input your password again': 'por favor introduzca su contraseña otra vez',
'Plugins': 'Plugins',
'Power Threshold Losses': 'Power Threshold Losses',
'Powered by': 'Este sitio usa',
'Preface': 'Prefacio',
'previous %s rows': 'fila %s anterior',
'Process Control and Reporting': 'Process Control and Reporting',
'Profile': 'Perfil',
...
'Specific Power Comparison': 'Specific Power Comparison',
'Specific Power Losses': 'Specific Power Losses',
'state': 'estado',
'Station Inverter Performance': 'Station Inverter Performance',
'Statistics': 'Estadísticas',
'Stn vs Inv': 'Stn vs Inv',
'String performance analysis': 'String performance analysis',
'String_performance_analysis': 'String_performance_analysis',
...
'Time Maximum Deviation': 'Time Maximum Deviation',
...
'Total Daily Losses': 'Total Daily Losses',
'Traceback': 'Rastrear',
'Tracker analysis': 'Tracker analysis',
'Tracker Angle Distribution': 'Tracker Angle Distribution',
